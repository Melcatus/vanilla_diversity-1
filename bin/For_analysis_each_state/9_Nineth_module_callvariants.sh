...
mkdir ../Process/data/filtered/filtered_third

##Do a new archive with filters applied
vcftools --vcf ../Process/data/popf/third_an/"populations.snps.vcf" --out ../Process/data/filtered/filtered_third/third --maf 0.1 --min-meanDP 10 --max-meanDP 1000 --max-missing 0.3 --remove-filtered-all --recode

##For the analysis with VCFtools
vcftools --vcf ../Process/data/popf/third_an/"populations.snps.vcf" --out ../Process/data/filtered/filtered_third/third --maf 0.1 --min-meanDP 10 --max-meanDP 1000 --max-missing 0.3 --remove-filtered-all [-some_analysis*]
