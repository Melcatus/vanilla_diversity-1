...
mkdir ../Process/data/filtered/filtered_second/culti

##Do a new archive with filters applied
vcftools --vcf ../Process/data/popf/second_an/culti/"populations.snps.vcf" --out ../Process/data/filtered/filtered_second/culti/cultian --maf 0.1 --min-meanDP 10 --max-meanDP 1000 --max-missing 0.1 --remove-filtered-all --recode

##For the analysis with VCFtools
vcftools --vcf ../Process/data/popf/second_an/culti/"populations.snps.vcf" --out ../Process/data/filtered/filtered_second/culti/cultian --maf 0.1 --min-meanDP 10 --max-meanDP 1000 --max-missing 0.1 --remove-filtered-all [-some_analysis*]
