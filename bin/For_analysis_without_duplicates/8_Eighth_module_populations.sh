...
stacks populations -P ../Process/data/gwens/second_an -O ../Process/data/popf/second_an -M ../Process/data/"pmap_nod.tsv" --min-samples-per-pop 0.01 --min-samples-overall 0.01 --min-population 1 --hwe --fstats --ordered-export --fasta-loci --fasta-samples --vcf --phylip --structure
