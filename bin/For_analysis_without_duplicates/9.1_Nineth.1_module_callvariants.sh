...
vcftools --vcf ../Process/data/popf/second_an/"populations.snps.vcf" --out ../Process/data/filtered/filtered_second/secondlack --maf 0.1 --min-meanDP 10 --max-meanDP 1000 --max-missing 0.1 --remove-filtered-all --recode

##For the analysis with VCFtools
vcftools --vcf ../Process/data/popf/second_an/"populations.snps.vcf" --out ../Process/data/filtered/filtered_second/secondlack --maf 0.1 --min-meanDP 10 --max-meanDP 1000 --max-missing 0.1 --remove-filtered-all [-some_analysis*]
