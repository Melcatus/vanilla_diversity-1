...
mkdir ../Process/data/filtered/filtered_first

##Do a new archive with filters applied
vcftools --vcf ../Process/data/popf/first_an/"populations.snps.vcf" --out ../Process/data/filtered/filtered_first/first --maf 0.1 --min-meanDP 10 --max-meanDP 1000 --max-missing 0.3 --remove-filtered-all --recode

##For the analysis with VCFtools
vcftools --vcf ../Process/data/popf/first_an/"populations.snps.vcf" --out ../Process/data/filtered/filtered_first/first --maf 0.1 --min-meanDP 10 --max-meanDP 1000 --max-missing 0.3 --remove-filtered-all [-some_analysis*]
